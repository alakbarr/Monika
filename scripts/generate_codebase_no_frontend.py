...
def main():
    ...
    struktur_path = os.path.join(root_dir, "STRUKTUR_without_frontend_and_data_sources.md")
    output_path = os.path.join(root_dir, "all_codebase_without_frontend.md")
    ...
    # Priority files at the very top (removed INDEX.md)
    priority_files = [
        os.path.join(root_dir, "STRUKTUR_without_frontend_and_data_sources.md"),
    ...
    # Generate all_codebase_without_frontend.md
    with open(output_path, 'w', encoding='utf-8') as out_f:
        out_f.write("# All Codebase (No Frontend/Data Sources)\n\n")
        out_f.write(f"This file contains the complete source code for all files listed in STRUKTUR_without_frontend_and_data_sources.md.\n\n")
