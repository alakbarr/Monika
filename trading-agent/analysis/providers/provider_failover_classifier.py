...
_OVERLOAD_PATTERNS = re.compile(r"overloaded|503|529|service.?unavailable|capacity|high.?demand|spikes.?in.?demand|temporarily.?unavailable|model.?unavailable|unavailable", re.IGNORECASE)
