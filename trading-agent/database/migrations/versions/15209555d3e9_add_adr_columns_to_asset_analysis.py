"""add_adr_columns_to_asset_analysis

Revision ID: 15209555d3e9
Revises: 2ec802a503b0
Create Date: 2026-08-19 23:37:09.788488
...
revision: str = '15209555d3e9'
down_revision: Union[str, Sequence[str], None] = '2ec802a503b0'
...
def upgrade() -> None:
    ...
    op.add_column('asset_analysis', sa.Column('adr_at_analysis', sa.Float(), nullable=True))
    op.add_column('asset_analysis', sa.Column('adr_tp_pct_used', sa.Float(), nullable=True))
    op.add_column('asset_analysis', sa.Column('adr_sl_pct_used', sa.Float(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('asset_analysis', 'adr_sl_pct_used')
    op.drop_column('asset_analysis', 'adr_tp_pct_used')
    op.drop_column('asset_analysis', 'adr_at_analysis')
