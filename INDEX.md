...
- [Root Directory: `/trading-agent`](#root-directory-trading-agent) - Line 102
  - [Folder: `.github`](#folder-github) - Line 125
    - [Folder: `.github/workflows`](#folder-githubworkflows) - Line 127
    - [Folder: `.github/ISSUE_TEMPLATE`](#folder-githubissue_template) - Line 131
  - [Folder: `docs`](#folder-docs) - Line 140
    - [Folder: `docs/images`](#folder-docsimages) - Line 142
  - [Folder: `scripts`](#folder-scripts) - Line 164
  - [Folder: `trading-agent`](#folder-trading-agent) - Line 193
    - [Folder: `trading-agent/systemd`](#folder-trading-agentsystemd) - Line 233
    - [Folder: `trading-agent/cli`](#folder-trading-agentcli) - Line 237
    - [Folder: `trading-agent/benchmark`](#folder-trading-agentbenchmark) - Line 336
      - [Folder: `trading-agent/benchmark/results`](#folder-trading-agentbenchmarkresults) - Line 376
    - [Folder: `trading-agent/agent`](#folder-trading-agentagent) - Line 391
      - [Folder: `trading-agent/agent/monitors`](#folder-trading-agentagentmonitors) - Line 410
    - [Folder: `trading-agent/analysis`](#folder-trading-agentanalysis) - Line 424
      - [Folder: `trading-agent/analysis/harness`](#folder-trading-agentanalysisharness) - Line 445
      - [Folder: `trading-agent/analysis/grounding`](#folder-trading-agentanalysisgrounding) - Line 479
      - [Folder: `trading-agent/analysis/subagent`](#folder-trading-agentanalysissubagent) - Line 486
      - [Folder: `trading-agent/analysis/arbitration`](#folder-trading-agentanalysisarbitration) - Line 493
      - [Folder: `trading-agent/analysis/stages`](#folder-trading-agentanalysisstages) - Line 500
        - [Folder: `trading-agent/analysis/stages/per_asset`](#folder-trading-agentanalysisstagesper_asset) - Line 512
      - [Folder: `trading-agent/analysis/validators`](#folder-trading-agentanalysisvalidators) - Line 530
      - [Folder: `trading-agent/analysis/calculators`](#folder-trading-agentanalysiscalculators) - Line 559
      - [Folder: `trading-agent/analysis/tools`](#folder-trading-agentanalysistools) - Line 592
        - [Folder: `trading-agent/analysis/tools/domain`](#folder-trading-agentanalysistoolsdomain) - Line 625
        - [Folder: `trading-agent/analysis/tools/handlers`](#folder-trading-agentanalysistoolshandlers) - Line 642
      - [Folder: `trading-agent/analysis/schemas`](#folder-trading-agentanalysisschemas) - Line 684
      - [Folder: `trading-agent/analysis/stages`](#folder-trading-agentanalysisstages-1) - Line 690
      - [Folder: `trading-agent/analysis/strategies`](#folder-trading-agentanalysisstrategies) - Line 700
        - [Folder: `trading-agent/analysis/strategies/synthesized`](#folder-trading-agentanalysisstrategiessynthesized) - Line 727
      - [Folder: `trading-agent/analysis/prefetch`](#folder-trading-agentanalysisprefetch) - Line 752
      - [Folder: `trading-agent/analysis/debate`](#folder-trading-agentanalysisdebate) - Line 773
      - [Folder: `trading-agent/analysis/validators`](#folder-trading-agentanalysisvalidators-1) - Line 822
      - [Folder: `trading-agent/analysis/providers`](#folder-trading-agentanalysisproviders) - Line 838
      - [Folder: `trading-agent/analysis/memory`](#folder-trading-agentanalysismemory) - Line 909
    - [Folder: `trading-agent/backtest`](#folder-trading-agentbacktest) - Line 973
    - [Folder: `trading-agent/graph`](#folder-trading-agentgraph) - Line 1076
      - [Folder: `trading-agent/graph/nodes`](#folder-trading-agentgraphnodes) - Line 1085
    - [Folder: `trading-agent/config`](#folder-trading-agentconfig) - Line 1112
    - [Folder: `trading-agent/data_sources`](#folder-trading-agentdata_sources) - Line 1142
    - [Folder: `trading-agent/database`](#folder-trading-agentdatabase) - Line 1277
      - [Folder: `trading-agent/database/domain_models`](#folder-trading-agentdatabasedomain_models) - Line 1525
      - [Folder: `trading-agent/database/migrations`](#folder-trading-agentdatabasemigrations) - Line 1550
        - [Folder: `trading-agent/database/migrations/archive`](#folder-trading-agentdatabasemigrationsarchive) - Line 1559
        - [Folder: `trading-agent/database/migrations/versions`](#folder-trading-agentdatabasemigrationsversions) - Line 1562
    - [Folder: `trading-agent/execution`](#folder-trading-agentexecution) - Line 1567
      - [Folder: `trading-agent/execution/service`](#folder-trading-agentexecutionservice) - Line 1760
      - [Folder: `trading-agent/execution/ea_bridge`](#folder-trading-agentexecutionea_bridge) - Line 1838
    - [Folder: `trading-agent/graph`](#folder-trading-agentgraph-1) - Line 1856
      - [Folder: `trading-agent/graph/checkpointers`](#folder-trading-agentgraphcheckpointers) - Line 1887
      - [Folder: `trading-agent/graph/nodes`](#folder-trading-agentgraphnodes-1) - Line 1894
        - [Folder: `trading-agent/graph/nodes/debate`](#folder-trading-agentgraphnodesdebate) - Line 1906
    - [Folder: `trading-agent/indicators`](#folder-trading-agentindicators) - Line 1987
    - [Folder: `trading-agent/logging_observability`](#folder-trading-agentlogging_observability) - Line 2060
      - [Folder: `trading-agent/logging_observability/reporting`](#folder-trading-agentlogging_observabilityreporting) - Line 2100
      - [Folder: `trading-agent/logging_observability/tracing`](#folder-trading-agentlogging_observabilitytracing) - Line 2113
      - [Folder: `trading-agent/logging_observability/dashboard`](#folder-trading-agentlogging_observabilitydashboard) - Line 2129
        - [Folder: `trading-agent/logging_observability/dashboard/routes`](#folder-trading-agentlogging_observabilitydashboardroutes) - Line 2206
        - [Folder: `trading-agent/logging_observability/dashboard/frontend`](#folder-trading-agentlogging_observabilitydashboardfrontend) - Line 2228
          - [Folder: `trading-agent/logging_observability/dashboard/frontend/src`](#folder-trading-agentlogging_observabilitydashboardfrontendsrc) - Line 2236
            - [Folder: `trading-agent/logging_observability/dashboard/frontend/src/components/charts`](#folder-trading-agentlogging_observabilitydashboardfrontendsrccomponentscharts) - Line 2243
            - [Folder: `trading-agent/logging_observability/dashboard/frontend/src/components/layout`](#folder-trading-agentlogging_observabilitydashboardfrontendsrccomponentslayout) - Line 2250
            - [Folder: `trading-agent/logging_observability/dashboard/frontend/src/components/panels`](#folder-trading-agentlogging_observabilitydashboardfrontendsrccomponentspanels) - Line 2257
              - [Folder: `trading-agent/logging_observability/dashboard/frontend/src/components/panels/config`](#folder-trading-agentlogging_observabilitydashboardfrontendsrccomponentspanelsconfig) - Line 2277
              - [Folder: `trading-agent/logging_observability/dashboard/frontend/src/components/panels/graph`](#folder-trading-agentlogging_observabilitydashboardfrontendsrccomponentspanelsgraph) - Line 2281
              - [Folder: `trading-agent/logging_observability/dashboard/frontend/src/components/panels/tokens`](#folder-trading-agentlogging_observabilitydashboardfrontendsrccomponentspanelstokens) - Line 2287
            - [Folder: `trading-agent/logging_observability/dashboard/frontend/src/components/ui`](#folder-trading-agentlogging_observabilitydashboardfrontendsrccomponentsui) - Line 2291
            - [Folder: `trading-agent/logging_observability/dashboard/frontend/src/hooks`](#folder-trading-agentlogging_observabilitydashboardfrontendsrchooks) - Line 2317
            - [Folder: `trading-agent/logging_observability/dashboard/frontend/src/lib`](#folder-trading-agentlogging_observabilitydashboardfrontendsrclib) - Line 2323
            - [Folder: `trading-agent/logging_observability/dashboard/frontend/src/store`](#folder-trading-agentlogging_observabilitydashboardfrontendsrcstore) - Line 2328
            - [Folder: `trading-agent/logging_observability/dashboard/frontend/src/types`](#folder-trading-agentlogging_observabilitydashboardfrontendsrctypes) - Line 2331
    - [Folder: `trading-agent/risk`](#folder-trading-agentrisk) - Line 2334
    - [Folder: `trading-agent/scheduler`](#folder-trading-agentscheduler) - Line 2417
    - [Folder: `trading-agent/scrapers`](#folder-trading-agentscrapers) - Line 2715
      - [Folder: `trading-agent/scrapers/calendar`](#folder-trading-agentscraperscalendar) - Line 2747
      - [Folder: `trading-agent/scrapers/macro`](#folder-trading-agentscrapersmacro) - Line 2783
      - [Folder: `trading-agent/scrapers/news`](#folder-trading-agentscrapersnews) - Line 2795
      - [Folder: `trading-agent/scrapers/sentiment`](#folder-trading-agentscraperssentiment) - Line 2921
      - [Folder: `trading-agent/scrapers/social`](#folder-trading-agentscraperssocial) - Line 2948
    - [Folder: `trading-agent/skills`](#folder-trading-agentskills) - Line 2966
      - [Folder: `trading-agent/skills/trading`](#folder-trading-agentskillstrading) - Line 2989
    - [Folder: `trading-agent/telegram_bot`](#folder-trading-agenttelegram_bot) - Line 3035
    - [Folder: `trading-agent/utils`](#folder-trading-agentutils) - Line 3432
      - [Folder: `trading-agent/utils/analytics`](#folder-trading-agentutilsanalytics) - Line 3452
      - [Folder: `trading-agent/utils/calibration`](#folder-trading-agentutilscalibration) - Line 3481
      - [Folder: `trading-agent/utils/protocol`](#folder-trading-agentutilsprotocol) - Line 3487
      - [Folder: `trading-agent/utils/api`](#folder-trading-agentutilsapi) - Line 3502
      - [Folder: `trading-agent/utils/validation`](#folder-trading-agentutilsvalidation) - Line 3529
      - [Folder: `trading-agent/utils/llm`](#folder-trading-agentutilsllm) - Line 3538
      - [Folder: `trading-agent/utils/market`](#folder-trading-agentutilsmarket) - Line 3602
      - [Folder: `trading-agent/utils/plugins`](#folder-trading-agentutilsplugins) - Line 3631
      - [Folder: `trading-agent/utils/infra`](#folder-trading-agentutilsinfra) - Line 3640
      - [Folder: `trading-agent/utils/scheduling`](#folder-trading-agentutilsscheduling) - Line 3665
